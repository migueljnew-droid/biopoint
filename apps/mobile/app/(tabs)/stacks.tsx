...
const styles = StyleSheet.create({
    ...
    itemRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: spacing.sm, borderTopWidth: 0, borderTopColor: 'transparent' },
    itemInfo: { flex: 1 },
    ...
    addItemButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.xs, paddingTop: spacing.md, marginTop: spacing.sm, borderTopWidth: 0, borderTopColor: 'transparent' },
    addItemButtonPressed: { opacity: 0.7 },
    addItemText: { ...typography.label, color: colors.primary, fontWeight: '500' },
    modalOverlay: { flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.75)', justifyContent: 'flex-end' },
    modalContent: { padding: spacing.lg, maxHeight: '85%', borderWidth: 0, borderBottomWidth: 0, borderColor: 'transparent' },
    modalHandle: { width: 36, height: 4, backgroundColor: colors.glass.solid, borderRadius: 2, alignSelf: 'center', marginBottom: spacing.md },
    modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.lg, paddingBottom: spacing.md, borderBottomWidth: 0, borderBottomColor: 'transparent' },
    ...
    input: { backgroundColor: colors.glass.light, borderWidth: 0, borderColor: 'transparent', borderRadius: borderRadius.lg, padding: spacing.md, color: colors.textPrimary, ...typography.body },
